/*Este arquivo possui somente a finalidade de contribuir para a compreensão de lógica de programação
aplicada a Javascript, não integrando a totalidade do projeto*/

var perfil; //Declaração de variável
perfil = "docente"; //Atribuição de valor à variável
...
function calcularCargaHorariaDiaria(cargaHoraria, dias) {
    resultado = cargaHoraria/dias;
    return resultado; 

}

calcularCargaHorariaDiaria(40, 5)
console.log("A carga horaria por dia é o resultado de " + cargaHoraria
    + " horas dividido por " + dias + " dias = " + resultado + " horas");